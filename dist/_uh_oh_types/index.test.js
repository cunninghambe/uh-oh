...
import { BreadcrumbSchema, DeviceInfoSchema, EventEnvelopeSchema, JsonValueSchema, StackFrameSchema, UserSchema, } from './index.js';
const validFrame = {
    function: 'render',
    module: 'src/App.tsx',
    filename: 'App.tsx',
...
describe('EventEnvelopeSchema', () => {
    ...
    it('preserves unknown top-level fields (forward-compat)', () => {
        ...
        const r = EventEnvelopeSchema.parse(withUnknown);
    ...
    it('accepts tags as Record<string, string>', () => {
        ...
        expect(r.success).toBe(true);
        if (r.success)
            expect(r.data.tags).toEqual({ env: 'prod', ver: '1' });
    });
